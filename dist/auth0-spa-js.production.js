!(function(e, t) {
  ...
  var oe,
    ...
    Ae = function(e, t) {
      for (var n = Te(t), r = D.f, o = C.f, i = 0; i < n.length; i++) {
        var a = n[i];
        T(e, a) || r(e, a, o(t, a));
      }
    },
    ...
    Ie = function(e, t) {
      var n = xe[Ee(e)];
      return n == Pe || (n != Ce && ('function' == typeof t ? f(t) : !!t));
    },
  ...
  !(function(e, t, n, r, o, i, a) {
    !(function(e, t, n) {
      var r = t + ' Iterator';
      (e.prototype = St(jt, { next: y(1, n) })), Tt(e, r, !1), (At[r] = It);
    })(n, t, r);
    var c,
      u,
      s,
    ...
    if (
      (m &&
        ...
        xt !== Object.prototype &&
          c.next &&
          (ft(c) !== xt &&
            (Et ? Et(c, xt) : 'function' != typeof c[Pt] && R(c, Pt, Ut)),
          Tt(c, l, !0))),
      'values' == o &&
        h &&
        'values' !== h.name &&
      ...
      if (
        ...
        for (s in u) (!Ct && !d && s in p) || ae(p, s, u[s]);
      else Re({ target: t, proto: !0, forced: Ct || d }, u);
  })(
    String,
    'String',
    function(e) {
  ...
  var Ft = function(e, t, n, r) {
    ...
    Wt = Array.prototype,
    zt = function(e) {
      return void 0 !== e && (At.Array === e || Wt[Mt] === e);
    },
    qt = function(e, t, n) {
      var r = k(t);
  ...
  var Bt = '[object z]' === String(Nt),
    ...
    Yt = qe('iterator'),
    Vt = function(e) {
      if (null != e) return e[Yt] || e['@@iterator'] || At[Ht(e)];
    },
    Xt = qe('iterator'),
    Kt = !1;
  try {
  ...
  if (
    ...
    for (en in yn) s[en] && Et(s[en], un);
  if ((!hn || !sn || sn === fn) && ((sn = un.prototype), hn))
    for (en in yn) s[en] && Et(s[en].prototype, sn);
      ...
      for (
        var n = kn.call(_n(this), e, t),
          r = (function(e, t) {
            var n,
              r = P(e).constructor;
            return void 0 === r || null == (n = P(r)[bn]) ? t : et(n);
    ...
    Cn = (function(e, t) {
      ...
      return (In[e] =
        ...
        !f(function() {
          if (r && !l) return !0;
          var e = { length: -1 };
          r ? jn(e, 1, { enumerable: !0, get: En }) : (e[1] = 1),
            n.call(e, o, i);
        }));
  ...
  'Promise' in Bn
    ? Bn.Promise.prototype.finally || (Bn.Promise.prototype.finally = Pn)
    : (Bn.Promise = Ln),
    (function(e) {
      function t() {}
      function n(e, t) {
  ...
  function jr(e) {
    return r(this, void 0, void 0, function() {
      ...
      return o(this, function(r) {
        switch (r.label) {
          case 0:
            if (((t = new Ar(e)), !vr('auth0.is.authenticated'))) return [2, t];
            r.label = 1;
          case 1:
            return (
              r.trys.push([1, 3, , 4]),
  ...
  return Object.assign(jr, { Auth0Client: Ar, createAuth0Client: jr });
}),
  'Auth0Client' in this &&
    this.console &&
    this.console.warn &&
